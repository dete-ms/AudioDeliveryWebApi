...
public class SearchService : ISearchService
{
    ...
    public async Task<SearchResultDto> SearchAsync(string query, string types, string? market = null, int limit = 20, int offset = 0, CancellationToken cancellationToken = default)
    {
