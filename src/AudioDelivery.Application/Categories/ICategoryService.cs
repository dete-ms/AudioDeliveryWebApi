...
public interface ICategoryService
{
    ...
    /// </summary>
    Task<PaginatedResult<CategoryDto>> GetCategoriesAsync(string? country = null, string? locale = null, int offset = 0, int limit = 20, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<PaginatedResult<PlaylistSummaryDto>> GetCategoryPlaylistsAsync(Guid categoryId, string? country = null, int offset = 0, int limit = 20, CancellationToken cancellationToken = default);
}
